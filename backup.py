...
from app.workflow import save_database
...
from app.financial_functions import py_moving_averages # type: ignore
...
def main():
    ...
    if ticker:
        ...
        if df is not None:
            ...
            print('Please enter valid stock data.')
